...
export const useActivities = (id?:string) => {
    ...
    const updateAttendance = useMutation({
        ...
        onError: (error, activityId, contex) => {
            console.log('prev: '+contex?.prevActivity);
            console.log(error);
            if (contex?.prevActivity){
                queryClinet.setQueryData(['activities', activityId], contex.prevActivity)
            }
        }
    })
